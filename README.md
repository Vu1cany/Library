...
1. Склонировать в директорию: https://github.com/Vu1cany/Library   
2. Сконфигурировать Tomcat(10.1.8)
3. В файле database.properties.origin убрать окончание ".origin", прописать в файле драйвер базы данных, ссылку на базу данных, имя пользователя и пароль
4. Запустить проект
